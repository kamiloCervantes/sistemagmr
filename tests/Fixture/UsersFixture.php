...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_Usuarios_Roles1_idx' => ['type' => 'index', 'columns' => ['Roles_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_Usuarios_Roles1' => ['type' => 'foreign', 'columns' => ['Roles_id'], 'references' => ['roles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'fecha_creacion' => '2016-11-17 20:41:42',
            'estado' => 1,
            'Roles_id' => 1
        ],
    ];
